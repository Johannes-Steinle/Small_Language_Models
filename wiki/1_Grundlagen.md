...
3.  **Reward Modeling + RLHF → Aligned Assistant:** Um das Modell nicht nur fähig, sondern auch wertekonform zu machen, folgt ein weiterer Schritt: [[8]](#quellen)
    ...
    *   **RLHF (Reinforcement Learning from Human Feedback):** Das Sprachmodell wird mittels Reinforcement Learning (z.B. PPO-Algorithmus) optimiert, um die Bewertung des Belohnungsmodells zu maximieren. Das Ergebnis: Das Modell wird hilfsbereiter, wahrhaftiger und weniger toxisch. [[8]](#quellen)
